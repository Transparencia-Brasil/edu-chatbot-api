...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('respostas', {
      ...
      relacao_escola: Sequelize.DataTypes.STRING,
      segmento_curso: Sequelize.DataTypes.STRING,
      nivel_escola: Sequelize.DataTypes.STRING,
      nome_escola: Sequelize.DataTypes.STRING,
